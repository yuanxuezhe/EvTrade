...
def get_task_endpoint(task_id: int, user: Row = Depends(get_current_user)):
...
async def stop_task_endpoint(task_id: int, user: Row = Depends(get_current_user)):
...
def delete_task_endpoint(task_id: int, user: Row = Depends(get_current_user)):
...
def get_task_logs_endpoint(task_id: int, user: Row = Depends(get_current_user)):
