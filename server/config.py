...
class Settings:
    ...
    # task_progress 实时推送队列 (strategy_exec → EvTrade → 前端 ws task_progress_update)
    # 订阅 routing_key "task.progress.*" (见 task_progress_consumer.py)
    STRATEGY_TASK_PROGRESS_QUEUE: str = _env("EVTRADE_STRATEGY_TASK_PROGRESS_QUEUE", "EvTrade.TaskProgress")
