"""
infra/db.py — SQLAlchemy 数据库基类层（v13 从 server/db.py 整体搬迁）

职责：封装 SQLite + SQLAlchemy 1.4 细节，对上层暴露 Session/Base/上下文管理器。

依赖：仅 stdlib + sqlalchemy + server.models（注册 ORM 元数据）。
"""
import os
import logging
